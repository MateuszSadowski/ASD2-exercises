...
namespace ASD
{
    class CyclePartitionTestCase : TestCase
    {
        ...
        public override void VerifyTestCase(out Result resultCode, out string message, object ob)
        {
            Graph GCopy = G.Clone();
            if (result == null)
            {
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            TestSet cyclePartitionTests = new TestSet(ob, "");
            TestSet matchingTests = new TestSet(ob, "");
            ...
            cyclePartitionTests.PerformTests(true, false);

            Console.WriteLine("***************************  Perfect matching tests  ***************************");
            matchingTests.PerformTests(true, false);
        }
    }
}
